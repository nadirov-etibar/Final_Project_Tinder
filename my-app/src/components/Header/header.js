        ...
        return (
                <header  >
                    ...
                    onClick={(e)=>{ 
                        ...
                        if(e.target.classList.contains("heada")){
                            let heads=document.querySelectorAll(".heada");
                            heads.forEach((x)=>x.classList.remove("header__active"));
                            e.target.classList.add("header__active")
                        }

                    }}>
                       
                        <svg 
                        className="Sq(28px) Fill($c-dark-gray) "
                        viewBox="0 0 24 24" 
                        width="35px" 
                        height="35px"
                            ...
                            <Link to="/profile">
                                <path className="heada header__svg-grey "
                        ...
                        <svg className="flame Sq(24px) " viewBox="0 0 24 24" width="35px" height="35px" focusable="false"
                             aria-hidden="true" role="presentation">
                                 <Link to="/swipe">
                            <path className="heada header__svg-grey  header__active"
                        ...
                        <svg className="Sq(28px) Fill($c-dark-gray) " viewBox="0 0 24 24" width="35px" height="35px"
                             focusable="false" aria-hidden="true" role="presentation">
                            <Link to="/message">
                            <path className="heada header__svg-grey"
