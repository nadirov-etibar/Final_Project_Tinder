        ...
        return (
                <header  >
                    ...
                    onClick={(e)=>{
                       ...
                       <Link to="/profile">
                        <svg 
                        className="Sq(28px) Fill($c-dark-gray)  heada header__svg-grey " 
                        viewBox="0 0 24 24" 
                        width="35px" 
                        height="35px"
                       ...
                       <Link to="/swipe">
                        <svg className="flame Sq(24px) header__svg-grey heada header__active" viewBox="0 0 24 24" width="35px" height="35px" focusable="false"
                        ...
                        <svg className="Sq(28px) Fill($c-dark-gray) heada header__svg-grey" viewBox="0 0 24 24" width="35px" height="35px"
                             focusable="false" aria-hidden="true" role="presentation">
                            <path 
