        ...
        return (
                <header  >
                    ...
                    onClick={(e)=>{ 
                        ...
                        <svg 
                        className="Sq(28px) Fill($c-dark-gray) header__svg-grey " 
                        viewBox="0 0 24 24" 
                        width="35px" 
                        height="35px"
                        ...
                        <svg className="flame Sq(24px) header__svg-grey  " viewBox="0 0 24 24" width="35px" height="35px" focusable="false"
                        ...
                        <svg className="Sq(28px) Fill($c-dark-gray) header__svg-grey" viewBox="0 0 24 24" width="35px" height="35px"
                             focusable="false" aria-hidden="true" role="presentation">
                            <path className="heada"
