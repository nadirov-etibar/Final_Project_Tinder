        ...
        return (
                <header >
                    <nav className={"header"}>
                        <svg className="Sq(28px) Fill($c-dark-gray) header__account header__active" viewBox="0 0 24 24" width="50px" height="50px"
                        ...
                        <svg className="flame Sq(24px) header__main-page" viewBox="0 0 24 24" width="50px" height="50px" focusable="false"
                        ...
                        <svg className="Sq(28px) Fill($c-dark-gray) header__message" viewBox="0 0 24 24" width="50px" height="50px"
                             focusable="false" aria-hidden="true" role="presentation">
                            <path
