    ...
    render() {
        return (
            <div>
              <header>
                  <nav>
                      <svg className="Sq(28px) Fill($c-dark-gray)" viewBox="0 0 24 24" width="24px" height="24px"
                      ...
                      <svg className="flame Sq(24px)" viewBox="0 0 24 24" width="24px" height="24px" focusable="false"
                ...
                <div>
                    ...
                    <div>
                       <Button class_name={"circle-btn"} value={"setting"}/>
                       <Button class_name={"circle-btn"} value={"camera"}/>
                       <Button class_name={"circle-btn"} value={"pencil"}/>
                    </div>
                </div>
            </div>
        );
